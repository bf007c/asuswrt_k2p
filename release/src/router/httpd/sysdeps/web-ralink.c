...
#if defined(RTAC52U) || defined(RTAC51U) || defined(RTN54U) || defined(RTAC1200HP) || defined(RTAC54U) || defined(RTAC1200) || defined(RTAC1200GA1) || defined(RTAC1200GU) || defined(RTACRH26)
		case BW_80:
			return "80M";
#endif
...
static int wl_scan(int eid, webs_t wp, int argc, char_t **argv, int unit)
{
	...
	snprintf(header, sizeof(header), "%-4s%-33s%-20s%-23s%-9s%-7s%-7s%-3s%-4s%-5s\n", 
